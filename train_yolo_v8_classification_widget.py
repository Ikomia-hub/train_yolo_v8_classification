...
from train_yolo_v8_classification.train_yolo_v8_classification_process import TrainYoloV8ClassificationParam
...
# --------------------
class TrainYoloV8ClassificationWidget(core.CWorkflowTaskWidget):

    def __init__(self, param, parent):
        core.CWorkflowTaskWidget.__init__(self, parent)

        if param is None:
            self.parameters = TrainYoloV8ClassificationParam()
        else:
...
# --------------------
class TrainYoloV8ClassificationWidgetFactory(dataprocess.CWidgetFactory):

    def __init__(self):
        dataprocess.CWidgetFactory.__init__(self)
        # Set the name of the process -> it must be the same as the one declared in the process factory class
        self.name = "train_yolo_v8_classification"

    def create(self, param):
        # Create widget object
        return TrainYoloV8ClassificationWidget(param, None)
